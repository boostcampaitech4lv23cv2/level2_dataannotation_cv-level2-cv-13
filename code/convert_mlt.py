...
def main():
    ...
    ICDAR2017_val = MLT17Dataset(SRC_DATASET_DIR, 'ICDAR17_val',
                             osp.join(SRC_DATASET_DIR, 'ICDAR17_val/ICDAR2017-gt_val'),
                             copy_images_to=None)
    ICDAR2017 = MLT17Dataset(SRC_DATASET_DIR, 'ICDAR17',
                             osp.join(SRC_DATASET_DIR, 'ICDAR17/ICDAR2017-gt'),
                             copy_images_to=None)
    ICDAR2019 = MLT19Dataset(SRC_DATASET_DIR, 'ICDAR19',
                             osp.join(SRC_DATASET_DIR, 'ICDAR19/ICDAR2019-gt'),
                             copy_images_to=None)
